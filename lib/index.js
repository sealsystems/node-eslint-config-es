...
module.exports = {
  ...
  rules: {
    ...
    'require-atomic-updates': 0, // DISABLE over-reacting rule
    ...
    'jest/no-test-callback': 0, // Not possible as long there are still tests with callbacks in some repositories
